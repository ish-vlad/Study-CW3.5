...
public class OpenDBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
	    ...
	    db.execSQL("CREATE TABLE "+ DBNames.TABLES.OBJECT + " ("
	          ...
	          + DBNames.TABLES.OBJECT.CELLS.HAS_COURSE_WORK + " INTEGER CHECK ( " +
	          		DBNames.TABLES.OBJECT.CELLS.HAS_COURSE_WORK + " >= 0 AND  " +
	          		DBNames.TABLES.OBJECT.CELLS.HAS_COURSE_WORK + " <= 1) DEFAULT 0 "
	    	  + ");"
	          );
	    ...
	    db.execSQL("CREATE TABLE "+ DBNames.TABLES.CLASS_LECTURE + " ("
		    	...
		    	+ DBNames.TABLES.CLASS_LECTURE.CELLS.CLASS_ID + " INTEGER,"
		    	+ DBNames.TABLES.CLASS_LECTURE.CELLS.LECTURE_ID + " INTEGER,"
			    + "FOREIGN KEY(" +
			    	DBNames.TABLES.CLASS_LECTURE.CELLS.CLASS_ID + ") REFERENCES " +
			    	DBNames.TABLES.CLASS + "(" +
			    	DBNames.TABLES.CLASS.CELLS.ID +	"),"
			    + "FOREIGN KEY(" +
	    ...
	    db.execSQL("CREATE TABLE "+ DBNames.TABLES.STUDENT_LECTURE + " ("
		    	...
		    	+ DBNames.TABLES.STUDENT_LECTURE.CELLS.LECTURE_ID + " INTEGER,"
			    + "FOREIGN KEY(" +
			    	DBNames.TABLES.STUDENT_LECTURE.CELLS.STUDENT_ID + ") REFERENCES " +
			    	DBNames.TABLES.STUDENT + "(" +
			    	DBNames.TABLES.STUDENT.CELLS.ID +	"),"
			    + "FOREIGN KEY(" +
			    	DBNames.TABLES.STUDENT_LECTURE.CELLS.LECTURE_ID + ") REFERENCES " +
			    	DBNames.TABLES.LECTURE + "(" +
			    	DBNames.TABLES.LECTURE.CELLS.ID + ")"  
			    + ");"
			    );
	    ...
	    db.execSQL("INSERT INTO Student(name, class_id) VALUES ('Vse poseschaet iz 1', 1);");
	    db.execSQL("INSERT INTO Student(name, class_id) VALUES ('4erez raz iz 1', 1);");
	    db.execSQL("INSERT INTO Student(name, class_id) VALUES ('Nichego iz 1', 1);");
	    db.execSQL("INSERT INTO Student(name, class_id) VALUES ('Vse poseschaet iz 2', 2);");
	    db.execSQL("INSERT INTO Student(name, class_id) VALUES ('4erez raz iz 2', 2);");
	    db.execSQL("INSERT INTO Student(name, class_id) VALUES ('Nichego iz 2', 2);");
	    db.execSQL("INSERT INTO Student(name, class_id) VALUES ('Vse poseschaet iz 3', 3);");
	    db.execSQL("INSERT INTO Student(name, class_id) VALUES ('4erez raz iz 3', 3);");
	    db.execSQL("INSERT INTO Student(name, class_id) VALUES ('Nichego iz 3', 3);");
	    db.execSQL("INSERT INTO Student(name, class_id) VALUES ('Vse poseschaet iz 4', 4);");
	    db.execSQL("INSERT INTO Student(name, class_id) VALUES ('4erez raz iz 4', 4);");
	    db.execSQL("INSERT INTO Student(name, class_id) VALUES ('Nichego iz 4', 4);");
